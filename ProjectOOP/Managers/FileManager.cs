...
//    {
//        private const string FileTaskPath = "tasks.json";
//        private const string FileUserPath = "users.json";

//        public void SaveTasks(List<UserTask> tasks)
//        {
//            var json = JsonSerializer.Serialize(tasks, new JsonSerializerOptions { WriteIndented = true });
//            File.WriteAllText(FileTaskPath, json);
//        }
...
//        {
//            if (!File.Exists(FileTaskPath)) return new List<UserTask>();
//            var json = File.ReadAllText(FileTaskPath);
//            return JsonSerializer.Deserialize<List<UserTask>>(json) ?? new List<UserTask>();
//        }

//        public List<User> LoadUsers()
//        {
//            if (!File.Exists(FileUserPath)) return new List<User>();
//            var json = File.ReadAllText(FileUserPath);
